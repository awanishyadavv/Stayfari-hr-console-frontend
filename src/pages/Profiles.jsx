...
const Profiles = () => {
    ...
    const columns = [
      {
        Header: "S.No",
        accessor: (row, index) => (
          <div className="customer-content">{index + 2}</div>
        ),
      },
      {
        Header: "Customer",
  ...
  const handleCloseModel1 = async (e) => {
    e.preventDefault();
      setIsModelOpen(false);
      setSelectedRowData(null);
      setCountry("");
  ...
  const querySearch = (e) => {
    ...
    window.open(
      `https://www.google.com/search?q=${selectedRowData.Phone}`,
      "_bank"
    );
    window.open(
      `https://phonenum.info/en/phone/${selectedRowData.Phone}`,
      "_bank"
    );
  };
        ...
        <div className="model" onClick={handleCloseModel}>
          <div className="overlay">
            <form action="" className="model-content" onSubmit={submitHandler}>
              <div className="overlay-section no-select">
                <div>
                  <h4>Customer Details:</h4>
                </div>
                <div className="customer no-select">
                  <div className="content no-select">
                    <p className="p1 no-select">Name</p>
                    <p className="p2 no-select">{selectedRowData.Customer}</p>
                  </div>
                  <div className="content no-select">
                    <p className="p1 no-select">Email</p>
                    <p className="p2">{selectedRowData.Email}</p>
                  </div>
                  <div className="content no-select">
                    <p className="p1 no-select">Phone</p>
                    <p className="p2 no-select">{selectedRowData.Phone}</p>
                  </div>
                </div>
              </div>
              <div className="overlay-section details no-select">
                <div>
                  <h4>Details: </h4>
                </div>
                <div className="customer no-select">
                  <div className="content no-select">
                    <p className="p1 no-select">Adults</p>
                    <p className="p2 no-select">{selectedRowData.Adults}</p>
                  </div>
                  <div className="content no-select">
                    <p className="p1 no-select">Children</p>
                    <p className="p2 no-select">{selectedRowData.Children}</p>
                  </div>
                  <div className="content no-select">
                    <p className="p1 no-select">Days</p>
                    <p className="p2 no-select">{selectedRowData.Days}</p>
                  </div>
                </div>
              </div>
              <div className="overlay-section no-select">
                ...
                <div className="customer no-select">
                  <div className="content no-select">
                    <p className="p1 no-select">Vehicle</p>
                    <p className="p2 no-select">{selectedRowData.Vehicle}</p>
                  </div>
                  <div className="content v">
                    <p className="p1 no-select">Value</p>
                    <p className="p2 no-select">{`$${selectedRowData["Value ($)"]}`}</p>
                  </div>
                  <div className="content no-select">
                    <p className="p1 no-select">Run Queries</p>
                    <button className="p2 btn-open-query" onClick={querySearch}>
                      OPEN
                    </button>
                  </div>
                </div>
              ...
              <div className="overlay-section no-select">
                ...
                <div className="itinerary no-select">
                  <p className="no-select">{selectedRowData.Itinerary} </p>
                </div>
              </div>
              <div className="overlay-section no-select">
                <div>
                ...
                <div className="customer no-select">
                  <div className="content no-select">
                    <p className="p1 no-select">Country</p>
                    <input
                      className="p2 input"
                      type="text"
